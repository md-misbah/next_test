...
const certificateDescription = ["Master the AI-900 exam! Participated in the Azure AI Fundamentals Cloud Skills Challenge to solidify core concepts. Gained hands-on learning and ace quizzes to excel in AI Overview, Explore visual tools for machine learning, Computer Vision, and Natural Language Processing. Showcased my Azure expertise confidently...", "Obtained this certificate on completion of 'Azure AI Fundamentals : Cloud Skills Challenge' including 14 tests, 7 labs for exploring visual tools for machine learning & 1 overview test.", "Learned how to create and deploy AI solutions for various situations using Azure AI services, such as detecting emotions, faces, or forms. Also found helpful learning materials, code examples, and guides to assist me. Achieved this certification by completng the listed AI Skills Challenges: >_Build a natural language processing solution with Azure AI Language. >_Build an Azure AI Vision solution. >_Create an intelligent document processing solution with Azure AI Document Intelligence."];
